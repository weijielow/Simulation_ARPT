    ...
    def apply(self):
        try:
            self.result = {
                ...
                "simulation_days": int(self.simulation_days_entry.get())  # Parse the text input
            }
        except ValueError:
...
class NodeInputDialog(simpledialog.Dialog):
    ...
    def apply(self):
        try:
            ...
            regulation_value = regulation_mapping.get(self.government_regulation_var.get(), 0)
            ...
            self.result = {
                "total_land": float(self.land_entry.get()),
...
class SimulationGUI(tk.Tk):
    ...
    def get_initial_settings(self):
        ...
        if dialog.result:
            ...
            self.destroy()  # Close the program if no valid input
    ...
    def continue_simulation(self, delta_t):
        ...
        additional_days = simpledialog.askinteger("Continue Simulation",
                                                  "How many additional months do you want to simulate?", minvalue=1)
